...
// (low baseFrequency/scale paired with the heaviest 22px backdrop blur
// of the set — a deeply frosted, lens-like look). See data/code/Frost_Lens.ts
// for the per-framework markup.
</script>

<template>
  <div class="frost-lens-card">
