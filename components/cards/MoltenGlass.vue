...
// (highest baseFrequency of the set with a strong scale — a hot, roiling
// distortion). See data/code/Molten_Glass.ts for the per-framework markup.
</script>

<template>
  <div class="molten-glass-card">
