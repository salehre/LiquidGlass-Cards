...
// (mid baseFrequency/scale, sitting between Ice Ripple's tight ripple and
// Fluid Amber's broader wobble). See data/code/Ocean_Wave.ts for the
// per-framework markup.
</script>

<template>
  <div class="ocean-wave-card">
