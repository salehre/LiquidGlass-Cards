...
// (lower scale, higher baseFrequency than Card01/Card02 — a tighter,
// finer ripple instead of a broad wobble). See data/code/Ice_Ripple.ts for
// the per-framework markup.
</script>

<template>
  <div class="ice-ripple-card">
