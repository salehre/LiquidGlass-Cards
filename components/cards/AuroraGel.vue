...
// (mid-strength baseFrequency/scale/blur, sitting between Crystal Mist
// and Ocean Wave — a smooth, gel-like wobble). See data/code/Aurora_Gel.ts
// for the per-framework markup.
</script>

<template>
  <div class="aurora-gel-card">
