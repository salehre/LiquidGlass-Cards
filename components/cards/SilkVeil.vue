...
// (lowest baseFrequency/scale of the set, with a heavier backdrop blur —
// a soft, smooth, silky look instead of visible ripples). See
// data/code/Silk_Veil.ts for the per-framework markup.
</script>

<template>
  <div class="silk-veil-card">
